...
CREATE INDEX IF NOT EXISTS idx_course_prerequisites_root_node_id
    ON course_prerequisites(root_node_id);

CREATE INDEX IF NOT EXISTS idx_prerequisite_nodes_parent_id
    ON prerequisite_nodes(parent_id);

CREATE INDEX IF NOT EXISTS idx_prerequisite_nodes_dept_course
    ON prerequisite_nodes(department, course_number);
