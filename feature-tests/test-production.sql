...
CREATE INDEX IF NOT EXISTS idx_user_courses_user_level_term 
  ON user_courses(user_id, level_term);
CREATE INDEX IF NOT EXISTS idx_user_courses_user_dept_course_term 
  ON user_courses(user_id, department, course_number, level_term);
CREATE INDEX IF NOT EXISTS idx_prerequisite_nodes_parent_relation 
  ON prerequisite_nodes(parent_id, relation_type);
CREATE INDEX IF NOT EXISTS idx_prerequisite_nodes_parent_dept_course 
  ON prerequisite_nodes(parent_id, department, course_number);
CREATE INDEX IF NOT EXISTS idx_courses_dept_course 
