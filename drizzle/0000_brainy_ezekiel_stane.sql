...
CREATE TYPE "public"."requirement_type" AS ENUM('LEVEL', 'PROGRAM', 'FACULTY');--> statement-breakpoint
...
CREATE TABLE "course_level_requirements" (
	"department" varchar(10) NOT NULL,
	"course_number" varchar(10) NOT NULL,
	"level" varchar(5) NOT NULL,
	CONSTRAINT "course_level_requirements_department_course_number_level_pk" PRIMARY KEY("department","course_number","level")
);
--> statement-breakpoint
...
CREATE TABLE "course_program_restrictions" (
	...
	"restriction_type" "requirement_type" NOT NULL,
